...
set_property PACKAGE_PIN W15 [get_ports {strControl[4]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {strControl[4]}] 
set_property PACKAGE_PIN V15 [get_ports {strControl[5]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {strControl[5]}] 
set_property PACKAGE_PIN W14 [get_ports {strControl[6]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {strControl[6]}] 
set_property PACKAGE_PIN W13 [get_ports {strControl[7]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {strControl[7]}] 
set_property PACKAGE_PIN V2 [get_ports {numControl[8]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {numControl[8]}] 
set_property PACKAGE_PIN T3 [get_ports {numControl[9]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {numControl[9]}] 
set_property PACKAGE_PIN T2 [get_ports {numControl[10]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {numControl[10]}] 
